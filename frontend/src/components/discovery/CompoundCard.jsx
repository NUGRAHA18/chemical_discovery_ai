    ...
    <div className="card hover:shadow-xl transition-shadow">
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center space-x-2">
          <span className={`px-3 py-1 rounded-full text-sm font-medium ${
            validation_score >= 0.8 ? 'bg-green-100 text-green-700' :
            validation_score >= 0.6 ? 'bg-yellow-100 text-yellow-700' :
      ...
      {structure_image && (
        <div className="mb-4 bg-gray-50 rounded-lg p-4 flex justify-center">
          <img 
            src={`http://localhost:3000${structure_image}`} 
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-primary-50 rounded-lg p-3">
          <p className="text-xs text-primary-600 font-medium">Molecular Weight</p>
