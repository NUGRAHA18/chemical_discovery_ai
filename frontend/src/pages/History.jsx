      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {stats && (
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="card">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Total Discoveries</h3>
              <p className="text-3xl font-bold text-primary-600">{stats.totalDiscoveries}</p>
            </div>
            <div className="card">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Total Compounds</h3>
              <p className="text-3xl font-bold text-secondary-600">{stats.totalCompounds}</p>
            </div>
            <div className="card">
